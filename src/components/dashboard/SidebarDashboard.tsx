    ...
    return (
        <section className="flex bg-kuarter min-h-screen">
            <ul className="text-sm md:text-base text-primer font-semibold">
                <li>
                    <Link href={"/dashboard"} className="px-5 py-3 flex gap-3 items-center hover:bg-tersier hover:text-white">
                        <LayoutDashboardIcon size={20} />
                        <span>Dashboard</span>
                    </Link>
                </li>
                <li>
                    <Link href={"/dashboard/artikel-anda"} className="px-5 py-3 flex gap-3 items-center hover:bg-tersier hover:text-white">
                        <NotebookTextIcon size={20} />
                        <span>Artikel Anda</span>
                    </Link>
                </li>
                <li>
                    <Link href={"/create-artikel"} className="px-5 py-3 flex items-center gap-3 hover:bg-tersier hover:text-white" >
                ...
                <li>
                    <Link href={"/dashboard/profil"} className="px-5 py-3 flex gap-3 items-center hover:bg-tersier hover:text-white">
